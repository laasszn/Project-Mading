...
@section('content')
    <div class="admin-wrapper">
        <div class="admin-card">
            <h2 class="admin-title"><i class="fa-solid fa-image"></i> Tambah Foto Galeri</h2>
            ...
            <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="judul" class="form-control" placeholder="Contoh: Karya DMIYS" value="{{ old('judul') }}" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="deskripsi" class="form-control" placeholder="Deskripsi singkat foto...">{{ old('deskripsi') }}</textarea>
                </div>
