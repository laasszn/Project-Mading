...
<div class="container" style="max-width: 1000px; margin: 40px auto; color: #fff;">
    ...
    <table style="width: 100%; border-collapse: collapse; background: #1e1e1e; border-radius: 8px; overflow: hidden;">
        ...
        <tbody>
            @forelse($galeris as $item)
                <tr style="border-bottom: 1px solid #333;">
                    <td style="padding: 12px 15px;">
                        <img src="{{ asset('storage/' . $item->gambar) }}" width="80" height="50" style="object-fit: cover; border-radius: 4px;">
                    </td>
                    ...
                    <td style="padding: 12px 15px; text-align: center;">
                        <div style="display: flex; gap: 8px; justify-content: center;">
                            <a href="{{ route('admin.galeri.edit', $item->id) }}" style="background: #ffc107; color: #000; padding: 6px 12px; border-radius: 4px; text-decoration: none; font-weight: 600; font-size: 0.85rem;">Edit</a>
            ...
            @empty
                <tr>
                    <td colspan="4" style="text-align: center; padding: 20px; color: #aaa;">Belum ada foto. Silakan tambahkan foto baru.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
